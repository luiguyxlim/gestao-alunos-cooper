    ...
    >
      <div className="p-5 sm:p-7">
        ...
        <div className="mt-6 bg-gray-50 rounded-lg p-4">
          {/* Informações do estudante - Layout horizontal em lista */}
          <div className="space-y-2">
            {student.email && (
              <div className="flex items-center justify-between text-sm text-gray-600 py-1 border-b border-gray-100">
                ...
                <span className="truncate ml-2 max-w-[200px]">{student.email}</span>
              </div>
            )}
